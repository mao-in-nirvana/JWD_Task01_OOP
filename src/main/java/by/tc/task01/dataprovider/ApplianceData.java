...
public class ApplianceData {
    private final static String APPLIANCE_DATA = "Oven : POWER_CONSUMPTION=1000, WEIGHT=10, CAPACITY=32, DEPTH=60, HEIGHT=45.5, WIDTH=59.5;\n" +
    ...
    public static String getApplianceData() {
